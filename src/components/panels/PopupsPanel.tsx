  ...
  return (
    <div>
      ...
      <div className="popup-section" style={{ marginBottom: 14 }}>
        ...
        <div className="field">
          <div className="field-label">Icon shown in win/defeat screens</div>
      ...
      <div className="popup-section">
        ...
        <div className="field">
          <div className="field-label">Board Image</div>
        ...
        <div className="field">
          <div className="field-label">CTA Button Image</div>
      ...
      <div className="popup-section">
        ...
        <div className="field">
          <div className="field-label">Retry Button Image</div>
        ...
        <div className="field">
          <div className="field-label">Store Button Image</div>
        ...
        <div className="field">
          <label htmlFor="popup-hint-color">Hint Text Color</label>
          <input
            id="popup-hint-color"
            type="color"
        ...
        <div className="row">
          <div className="field">
            <label htmlFor="popup-hint-landscape-y">Landscape Y</label>
            <input id="popup-hint-landscape-y" type="number" step={5} value={hintLayout.landscapeY}
              onChange={e => setHintLayout({ landscapeY: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-hint-portrait-y">Portrait Y</label>
            <input id="popup-hint-portrait-y" type="number" step={5} value={hintLayout.portraitY}
              onChange={e => setHintLayout({ portraitY: +e.target.value })} />
          </div>
        </div>
        <div className="row">
          <div className="field">
            <label htmlFor="popup-hint-landscape-fontsize">Landscape font size</label>
            <input id="popup-hint-landscape-fontsize" type="number" step={0.5} min={8} max={32} value={hintLayout.landscapeFontSize}
              onChange={e => setHintLayout({ landscapeFontSize: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-hint-portrait-fontsize">Portrait font size</label>
            <input id="popup-hint-portrait-fontsize" type="number" step={0.5} min={8} max={32} value={hintLayout.portraitFontSize}
      ...
      <div className="popup-section">
        ...
        <div className="row">
          <div className="field">
            <label htmlFor="popup-speech-landscape-x">X (left)</label>
            <input id="popup-speech-landscape-x" type="number" step={5} value={speechLayout.landscapeX}
              onChange={e => setSpeechLayout({ landscapeX: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-speech-landscape-y">Y (top)</label>
            <input id="popup-speech-landscape-y" type="number" step={5} value={speechLayout.landscapeY}
              onChange={e => setSpeechLayout({ landscapeY: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-speech-landscape-fontsize">Font size</label>
            <input id="popup-speech-landscape-fontsize" type="number" step={0.5} min={8} max={32} value={speechLayout.landscapeFontSize}
        ...
        <div className="row">
          <div className="field">
            <label htmlFor="popup-speech-portrait-x">X (left)</label>
            <input id="popup-speech-portrait-x" type="number" step={5} value={speechLayout.portraitX}
              onChange={e => setSpeechLayout({ portraitX: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-speech-portrait-y">Y (top)</label>
            <input id="popup-speech-portrait-y" type="number" step={5} value={speechLayout.portraitY}
              onChange={e => setSpeechLayout({ portraitY: +e.target.value })} />
          </div>
          <div className="field">
            <label htmlFor="popup-speech-portrait-fontsize">Font size</label>
            <input id="popup-speech-portrait-fontsize" type="number" step={0.5} min={8} max={32} value={speechLayout.portraitFontSize}
